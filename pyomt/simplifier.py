...
from pyomt.walkers import handles
import pyomt.operators as op
import pyomt.typing as types
from pyomt.utils import set_bit
from pyomt.exceptions import PyomtValueError


class Simplifier(pyomt.walkers.DagWalker):
    """Perform basic simplifications of the input formula."""

    def __init__(self, env=None):
        pyomt.walkers.DagWalker.__init__(self, env=env)
    ...
    def walk_debug(self, formula, **kwargs):
        from pyomt.shortcuts import Equals, Iff, get_type, is_valid
    ...
    def walk_times(self, formula, args, **kwargs):
        ...
        const = None
        if is_algebraic:
            from pyomt.constants import Numeral
...
class BddSimplifier(Simplifier):
    ...
    def validate_simplifications(self, value):
        ...
        if len(possible_solvers) == 0:
            raise PyomtValueError("To validate at least another solver must "
                                  "be available!")
    ...
    def simplify(self, formula):
        ...
        from pyomt.logics import BOOL, QF_BOOL
