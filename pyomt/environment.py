...
import pyomt.printers
import pyomt.substituter
import pyomt.type_checker
import pyomt.oracles
import pyomt.formula
import pyomt.factory
import pyomt.decorators
import pyomt.typing
...
class Environment(object):
    ...
    attributes.
    """
    TypeCheckerClass = pyomt.type_checker.SimpleTypeChecker
    FormulaManagerClass = pyomt.formula.FormulaManager
    TypeManagerClass = pyomt.typing.TypeManager
    SimplifierClass = pyomt.simplifier.Simplifier
    #SubstituterClass = pyomt.substituter.MSSubstituter
    SubstituterClass = pyomt.substituter.MGSubstituter
    HRSerializerClass = pyomt.printers.HRSerializer
    ...
    SizeOracleClass = pyomt.oracles.SizeOracle
    AtomsOracleClass = pyomt.oracles.AtomsOracle
    TypesOracleClass = pyomt.oracles.TypesOracle
    ...
    def add_dynamic_walker_function(self, nodetype, walker, function):
        ...
        See :py:meth:`pyomt.walkers.generic.Walker.walk_error` for
        more information.
        """
    ...
    def factory(self):
        if self._factory is None:
            self._factory = pyomt.factory.Factory(self)
