...
import pyomt
import pyomt.smtlib
from pyomt.operators import (FORALL, EXISTS, AND, OR, NOT, IMPLIES, IFF,
                             SYMBOL, FUNCTION,
...
from pyomt.operators import  (BOOL_OPERATORS, THEORY_OPERATORS,
                              BV_OPERATORS, IRA_OPERATORS, ARRAY_OPERATORS,
                              STR_OPERATORS,
                              RELATIONS, CONSTANTS)

from pyomt.typing import BOOL, REAL, INT, BVType, STRING
from pyomt.decorators import deprecated, assert_infix_enabled
...
class FNode(object):
    ...
    def to_smtlib(self, daggify=True):
        ...
        """
        return pyomt.smtlib.printers.to_smtlib(self, daggify=daggify)
...
def _mgr():
    ...
    return pyomt.environment.get_env().formula_manager
