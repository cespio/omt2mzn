...
from pyomt.exceptions import (NoSolverAvailableError, SolverRedefinitionError,
                              NoLogicAvailableError,
                              SolverAPINotFound)
from pyomt.logics import QF_UFLIRA, LRA, QF_UFLRA
from pyomt.logics import AUTO as AUTO_LOGIC
from pyomt.logics import most_generic_logic, get_closer_logic
from pyomt.logics import convert_logic_from_string
from pyomt.oracles import get_logic
from pyomt.solvers.qelim import (ShannonQuantifierEliminator,
                                 SelfSubstitutionQuantifierEliminator)
from pyomt.solvers.solver import SolverOptions
from pyomt.solvers.portfolio import Portfolio
...
class Factory(object):
    ...
    def add_generic_solver(self, name, args, logics, unsat_core_support=False):
        from pyomt.smtlib.solver import SmtLibSolver
    ...
    def _get_available_solvers(self):
        ...
        try:
            from pyomt.solvers.z3 import Z3Solver
            installed_solvers['z3'] = Z3Solver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.msat import MathSAT5Solver
            installed_solvers['msat'] = MathSAT5Solver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.cvc4 import CVC4Solver
            installed_solvers['cvc4'] = CVC4Solver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.yices import YicesSolver
            installed_solvers['yices'] = YicesSolver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.bdd import BddSolver
            installed_solvers['bdd'] = BddSolver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.pico import PicosatSolver
            installed_solvers['picosat'] = PicosatSolver
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.btor import BoolectorSolver
    ...
    def _get_available_qe(self):
        ...
        try:
            from pyomt.solvers.z3 import Z3QuantifierEliminator
            self._all_qelims['z3'] = Z3QuantifierEliminator
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.msat import (MSatFMQuantifierEliminator,
        ...
        try:
            from pyomt.solvers.bdd import BddQuantifierEliminator
    ...
    def _get_available_interpolators(self):
        ...
        try:
            from pyomt.solvers.z3 import Z3Interpolator
            self._all_interpolators['z3'] = Z3Interpolator
        except SolverAPINotFound:
            pass

        try:
            from pyomt.solvers.msat import MSatInterpolator
