...
from pyomt.logics import LRA, LIA, QF_UFLIA, QF_UFLRA, QF_BV, PYSMT_QF_LOGICS
...
from pyomt.solvers.interpolation import Interpolator
...
class MSatBoolUFRewriter(IdentityDagWalker):
    ...
    def walk_function(self, formula, args, **kwargs):
        from pyomt.typing import FunctionType
        # Separate arguments
        bool_args = []
        other_args = []
        for a in args:
