...
class Substituter(pyomt.walkers.IdentityDagWalker):
    ...
    def __init__(self, env):
        pyomt.walkers.IdentityDagWalker.__init__(self, env=env, invalidate_memoization=True)
    ...
    def _push_with_children_to_stack(self, formula, **kwargs):
        ...
        if formula.is_quantifier():
            ...
            pyomt.walkers.IdentityDagWalker._push_with_children_to_stack(self,
                                                                         formula,
                                                                         **kwargs)
...
class MGSubstituter(Substituter):
    ...
    def walk_forall(self, formula, args, **kwargs):
        ...
        if formula in substitutions:
            ...
            qvars = [pyomt.walkers.IdentityDagWalker.walk_symbol(self, v, args, **kwargs)
