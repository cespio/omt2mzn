...
;     the top-most objective. e.g.: (set-model -1) always refers
;     to the most recently defined objective function on the
;     stack of objectives.
;
...
(set-model 0) ; minimize x
(get-model)

(set-model 1) ; maximize y
(get-model)
